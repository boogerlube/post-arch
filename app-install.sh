...
sudo pacman -S --needed --noconfirm ncdu htop btop putty bat fzf tldr exa gprename nomacs ristretto flameshot
...
#sudo pacman -S p7zip unrar tar rsync file-roller
